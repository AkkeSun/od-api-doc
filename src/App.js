...
import OdShop from "./component/project/OdShop";


// --------- 새로운 프로젝트를 추가합니다 ---------
const projects = [
  { name: "od-shop", path: "/od-shop", component: OdShop},
  { name: "Test2", path: "/test5", component: TestPage },
  { name: "Test3", path: "/test5", component: TestPage },
  { name: "Test4", path: "/test5", component: TestPage },
  ...
  return (
      <div className="top">
        <div className="container">
          <h1>od project API Documentation</h1>
